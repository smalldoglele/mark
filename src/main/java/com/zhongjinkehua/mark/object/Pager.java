...
public class Pager<T>  {
    ...
    public Pager(Integer currentPage,Integer pageSize,Integer totalCount,List<T> list) {
    ...
    public void setIsLastPage(boolean isFirstPage) {
